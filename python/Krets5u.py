...
V_TR= np.abs(v1) - 2 * V_F
V_TR= np.maximum(V_TR, 0)
...
plt.plot(t_ms, V_TR, label="Likerettet spenning $V_{TR}(t)$", color="gray")
...
plt.title("Fullbølgelikeretter med kondensator (10μF) over 2 perioder")
plt.grid(True)
plt.legend()
plt.tight_layout()
plt.show()
